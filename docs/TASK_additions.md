...
### In Progress
- [ ] init-16d-layout-and-tools.md - Fix status bar scrolling (regression from 16c) + hybrid item filtering

### Recently Completed (Inventory System - Jan 14, 2026)
- [x] prp-15-inventory-system.md - Server-side inventory tracking, BECMI starting equipment, item catalog
- [x] prp-16-inventory-fixes.md - Case-insensitive item removal, starting quantities, sticky header attempt
- [x] prp-16a-frontend-inventory-sync.md - CharacterSnapshot returns full Item objects, frontend syncs inventory
- [x] prp-16b-inventory-ui-polish.md - Inline quantity display `Rations (7)`, item increment logic
- [x] prp-16c-final-inventory-fixes.md - Auto-focus input, quote stripping, dynamic item keywords

### Up Next
- [ ] init-16d-layout-and-tools.md - Fix layout regression + block power items (hybrid filtering)
...
*Last updated: 2026-01-14 (inventory system PRPs 15-16c complete)*
